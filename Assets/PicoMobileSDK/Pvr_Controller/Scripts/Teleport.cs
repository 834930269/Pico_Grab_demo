...
public class Teleport : MonoBehaviour
{
    ...
    /// 眨眼颜色
    /// </summary>
    private Color fadeColor = new Color(0f, 0f, 0f, 1f);
    ...
    public GameObject CurrentController
    {
        ...
        {
            if (pd == null)
                pd = FindObjectOfType<Pvr_ControllerDemo>();
            //txt.text = pd.currentController.name+" ";
            return pd.currentController;
        }
    }
