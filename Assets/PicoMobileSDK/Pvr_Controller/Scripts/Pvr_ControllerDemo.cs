...
public static class ControllerRegister {
    public static GameObject HeadSetController;
    public static GameObject controller0;
    public static GameObject controller1;
...
public class Pvr_ControllerDemo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ControllerRegister.HeadSetController = HeadSetController;
        ControllerRegister.controller0 = controller0;
        ControllerRegister.controller1 = controller1;
    }
